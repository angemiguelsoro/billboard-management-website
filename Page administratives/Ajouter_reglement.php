<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql = "INSERT INTO reglement(NUMREGL,DATEREGL,MONTANTREGL,NUMFACT,CODETYPEREG) values('$num_reg','$Date','$montant','$facture','$typeregl')";
...
<head>
    ...
    <title>Ajout reglement</title>
    <link rel="shortcut icon" href="image/images.jpeg" type="image/x-icon"/>
    <link rel="stylesheet" href="style/adm_reglement.css">
</head>
<body>
    ...
    <section>
        <div class="box">
            <div class="container">
                <div class="form">
                    <h2>Ajout reglement</h2>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <span class="sucess"><?php echo $ok; ?></span>
                        <div class="inputbox">
                            <input type="text" placeholder="Numéro du reglement" name="num_reg" required>
                        </div>
                        ...
                        <div class="selectbox">
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_array($result3)) {
                                    echo '<option value="'.$row['CODETYPEREG'].'">'.$row['CODETYPEREG'].'</option>';
                                }
                        ...
                        <div class="inputbox">
                            <input type="submit" value="Ajouter reglement">
                        </div>

                        <div class="inputbox">
                            <a href="reglement.php">
                                <input type="button" value="Liste des reglements">
                            </a>
                        </div>
                    </form>
                </div>
