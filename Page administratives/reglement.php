<?php
    ...
    if(isset($_GET['delete'])) {
        ...
        $sql = "DELETE FROM reglement WHERE NUMREGL='".$_GET["delete"]."'";
...
<head>
    ...
    <title>Liste des reglements</title>
    <link rel="shortcut icon" href="image/images.jpeg" type="image/x-icon"/>
    <link rel="stylesheet" href="style/reglement.css">
</head>
<body>
            ...
            <table class="tableau">
                ...
                <tbody>
                    <?php
                        ...
                        $query = mysqli_query($conn,"select *from reglement");

                        while($row = mysqli_fetch_assoc($query)) {
                            echo '<tr><td>' .$row["NUMREGL"]. '</td>';
                            echo '<td>' .$row["NUMFACT"]. '</td>';
                            echo '<td>' .$row["CODETYPEREG"]. '</td>';
                            echo '<td>' .$row["DATEREGL"]. '</td>';
                            echo '<td>' .$row["MONTANTREGL"]. '</td>';
                            echo '<td><a href="update_reglement.php?update='.$row["NUMREGL"].'" class="btn"><img src="image/bouton-modifier.png"></a></td>';
                            echo '<td><a href="?delete='.$row["NUMREGL"].'" class="btn"><img src="image/supprimer.png"></a></td>';
                            '</tr>';
                        }
                    ?>
                </tbody>
