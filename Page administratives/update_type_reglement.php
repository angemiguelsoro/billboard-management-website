<?php
    ...
    $sql = "SELECT *FROM type_reglement WHERE CODETYPEREG='$code'";
    ...
    if(isset($_POST) & !empty($_POST)) {
        ...
        $sql2 = "UPDATE type_reglement SET CODETYPEREG='$code_typregl', LIBELLETYPEREG='$lib_typregl' WHERE CODETYPEREG='$code'";
        ...
        if($result2) {
            header("location: type_reglement.php");
        }
...
<head>
    ...
    <title>Modification type de reglement</title>
    <link rel="shortcut icon" href="image/images.jpeg" type="image/x-icon"/>
    <link rel="stylesheet" href="style/update_typreglement.css">
</head>
<body>
    ...
    <section>
        ...
        <div class="box">
            <div class="container">
                <div class="form">
                    <h2>Modification type reglement</h2>
                    <form action="" method="post">
                        <div class="inputbox">
                            <input type="text" placeholder="Code du type reglement" name="code_typregl" value="<?php echo $row["CODETYPEREG"]?>" required>
                        </div>
                        <div class="inputbox">
                            <input type="text" placeholder="Libelle du type reglement" name="lib_typregl" value="<?php echo $row["LIBELLETYPEREG"]?>" required>
                        </div>
                        <div class="inputbox">
                            <input type="hidden" name="code_typeregl_origine" value="<?php echo '.$_GET["update"].'?>">
                        </div>
                        <div class="inputbox">
                            <input type="submit" value="Mettre à jour le type de reglement">
                        </div>
                    </form>
                </div>
            </div>
