<?php
    ...
    if(isset($_GET['delete'])) {
        ...
        $sql = "DELETE FROM commune WHERE CODECOM='".$_GET["delete"]."'";
        $sql2 = "DELETE FROM client WHERE CODECOM='".$_GET["delete"]."'";
        $sql3 = "DELETE FROM panneau WHERE CODECOM='".$_GET["delete"]."'";
...
<head>
    ...
    <link rel="stylesheet" href="style/commune.css">
</head>
<body>
            ...
            <table class="tableau">
                ...
                <tbody>
                    <?php
                        ...
                        $query = mysqli_query($conn,"select *from commune");

                        while($row = mysqli_fetch_assoc($query)) {
                            echo '<tr><td>' .$row["CODECOM"]. '</td>';
                            echo '<td>' .$row["LIBELLECOM"]. '</td>';
                            echo '<td><a href="update_commune.php?update='.$row["CODECOM"].'" class="btn"><img src="image/bouton-modifier.png"></a></td>';
                            echo '<td><a href="?delete='.$row["CODECOM"].'" class="btn"><img src="image/supprimer.png"></a></td>';
                            '</tr>';
                        }
                    ?>
                </tbody>
