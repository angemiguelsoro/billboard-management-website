<?php
    ...
    $sql = "SELECT *FROM facture WHERE NUMFACT='$code'";
    ...
    if(isset($_POST) & !empty($_POST)) {
        ...
        $sql2 = "UPDATE facture SET NUMFACT ='$num_fact', DATEFACT ='$Date' WHERE NUMFACT='$code'";
...
<head>
    ...
    <link rel="stylesheet" href="style/update_facture.css">
</head>
<body>
                ...
                <div class="container">
                    <div class="form">
                        ...
                        <form action="" method="post">
                           <div class="inputbox">
                                <input type="text" placeholder=" Numéro de la facture" name="num_fact" required>
                           </div>
                           <div class="inputbox">
                            <input type="hidden" name="num_fact_origine" value="<?php echo '.$_GET["update"].'?>">
                            </div>
                           <div class="inputbox">
                                <input type="submit" value="Mettre à jour la facture">
                           </div>
                        </form>
                    </div>
                </div>
