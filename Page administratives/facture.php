<?php
    ...
    if(isset($_GET['delete'])) {
        ...
        $sql = "DELETE FROM facture WHERE NUMFACT='".$_GET["delete"]."'";
        $sql2 = "DELETE FROM contrat WHERE NUMFACT='".$_GET["delete"]."'";
        $sql3 = "DELETE FROM reglement WHERE NUMFACT='".$_GET["delete"]."'";
            ...
            <table class="tableau">
                ...
                <tbody>
                    <?php
                        ...
                        $query = mysqli_query($conn,"select *from facture");

                        while($row = mysqli_fetch_assoc($query)) {
                            echo '<tr><td>' .$row["NUMFACT"]. '</td>';
                            echo '<td>' .$row["DATEFACT"]. '</td>';
                            echo '<td><a href="update_facture.php?update='.$row["NUMFACT"].'" class="btn"><img src="image/bouton-modifier.png"></a></td>';
                            echo '<td><a href="?delete='.$row["NUMFACT"].'" class="btn"><img src="image/supprimer.png"></a></td>';
                            '</tr>';
                        }
                    ?>
                </tbody>
